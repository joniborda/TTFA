...
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        Pronóstico de ventas para toma de decisiones en comercio electrónico usando machine learning} \\[1.5cm]
        ...
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Dr. Ing. Facundo. Lucianna (FIUBA)} \\ 
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Ing. Michael Andrés Arredondo Mendoza (Okaratech)} \\[2cm]
