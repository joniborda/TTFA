...
\section{Logros y contribuciones generales}
...
\begin{itemize} 
	\item Cumplimiento integral de los requerimientos: se implementaron con éxito los siete requerimientos funcionales definidos, que abarcan desde la ingesta automatizada de datos de Shopify y Triple whale hasta la exportación de reportes en \texttt{CSV} y la generación de alertas de integridad.
