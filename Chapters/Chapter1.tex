...
\begin{figure}[htbp]
	...
	\caption{Flujo general del sistema: los datos Shopify y de Triple Whale se integran en un conjunto de datos unificado dentro del sistema Inventory Tracker. Dicho conjunto alimenta el modelo que genera el pronóstico de ventas.}
