...
\begin{itemize}
	...
	\item \texttt{lineItems}: donde se detalla cada producto incluido en la compra junto con sus cantidades.
	...
	\item \texttt{order\_number\_for\_customer}: señala el número de orden que representa dentro del historial del cliente (por ejemplo, un valor igual a 1 implica un cliente nuevo).
...
\begin{itemize}
	...
	\item Re-entrenamiento automatizado y seguimiento de experimentos: con una frecuencia programada, el sistema inicia el ciclo de modelado predictivo. En esta fase, se integra una herramienta de gestión del ciclo de vida de \textit{machine learning} (como Metaflow) que registra cada experimento y facilita la trazabilidad de los artefactos generados.
...
Estas variables permiten analizar la distribución de la demanda en ciclos semanales y mensuales. Para asegurar una representación exhaustiva, el sistema garantiza la cobertura de los 12 meses del año y los 7 días de la semana, lo que facilita la identificación de patrones de consumo recurrentes en cada periodo.
	...
	\texttt{revenue\_growth = totalRevenue.pct\_change()}
