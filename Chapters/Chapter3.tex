...
\item Re-ejecución selectiva de tareas fallidas sin afectar etapas exitosas.
...
La comunicación entre estos servicios se realiza mediante endpoints REST internos para operaciones síncronas y, cuando se requiere procesamiento asincrónico o desacoplamiento temporal, a través de colas de mensajería (por ejemplo, con Redis \citep{redis}). Este diseño permite que cada servicio evolucione y escale de forma independiente, sin afectar al resto del sistema.
