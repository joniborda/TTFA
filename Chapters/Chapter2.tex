...
\begin{itemize}
	...
	\item AWS S3 \citep{aws_s3}: ofrece un servicio de almacenamiento de objetos en la nube de AWS que con alta escalabilidad, disponibilidad, durabilidad y seguridad necesario para guardar los modelos y datos intermedios.
...
\begin{itemize}
	...
	\item Apache Airflow \citep{airflow}: framework de orquestación que define flujos de trabajo como DAGs (\textit{Directed Acyclic Graphs}) y permite programar ejecuciones periódicas, manejar dependencias entre tareas y monitorizar el estado de los procesos de datos.
