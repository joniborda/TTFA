...
En la presente memoria se describe el desarrollo de un modelo de inteligencia artificial para el pronóstico de ventas en la tienda en línea de la empresa Latech \citep{latechfactory}, dedicada a la producción y comercialización de barritas alimenticias. El trabajo tiene como finalidad mejorar la planificación de la producción y facilitar la gestión del inventario y toma de decisiones estratégicas en la empresa.
